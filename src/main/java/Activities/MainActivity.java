...
import Activities.BLConnectionService;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private Button btnEnableDisableDiscoverable;
    ...
    private BLConnectionService mBluetoothConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = findViewById(R.id.lvNewDevices);
        ...
        // Boradcasts when bond state changes (ie: pairing)
    ...
    private void enableDisableBT() {
        if(mBluetoothAdapter == null) {
            Log.d(TAG,"enableDisableBT: Dies not have BT capabilities");
        }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        mBluetoothConnection = new BLConnectionService(MainActivity.this);
        Log.d(TAG,"mBluetoothConnection erstellt!");
    }
}
